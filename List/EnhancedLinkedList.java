...
public class EnhancedLinkedList<T> implements ListInterface<T> {
    ...
    private class Node {
        ...
        /**
         * To set the pointer of the next node
         *
...
/* ---------------------- Other Methods --------------------------------------*/
    ...
    public T remove(int givenPosition) {
        ...
        if (givenPosition == 1) {
            ...
            removedData = previousNode.getNextNode().getData();
    ...
    public boolean contains(T anEntry) {
        return containsRecursive(head, anEntry);
    }
    private boolean containsRecursive(Node currentNode, T target) {
        if (currentNode == null) {
            return false;
        }
        ...
        return containsRecursive(currentNode.getNextNode(), target);
    }
